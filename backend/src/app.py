...
from src.routes import authRoutes, sosRoutes, routeRoutes, heatmapRoutes, reportRoutes, userRoutes, safeHavenRoutes, watchRoutes
...
app.include_router(watchRoutes.router, prefix="/api/watch", tags=["Peer Escort"])
